              ...
              <div className="space-y-3">
                ...
                {(ragNli.policyVersion || ragNli.policyCategory || ragNli.policyEffectiveAt) && (
                  <div className="rounded-lg bg-muted/30 border border-border/50 p-2.5 space-y-1">
                    ...
                    <div className="grid grid-cols-2 gap-x-3 gap-y-0.5 text-[11px]">
                      {ragNli.policyVersion && (<><span className="text-muted-foreground">Version:</span><span className="font-semibold text-foreground">{ragNli.policyVersion}</span></>)}
                      ...
                      {ragNli.policyEffectiveAt && (<><span className="text-muted-foreground">Effective:</span><span className="font-semibold text-foreground">{ragNli.policyEffectiveAt}</span></>)}
                    </div>
                ...
                {ragNli.policyAlignmentScore != null && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[12px] font-bold" style={{ color: getScoreColor(ragNli.policyAlignmentScore) }}>{ragNli.policyAlignmentScore}%</span>
                  </div>
                )}
