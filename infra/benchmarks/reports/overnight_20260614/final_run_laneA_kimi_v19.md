## VocalMind Ollama Cloud Model Benchmark — 2026-06-16 16:18 UTC
...
|---|---|---|---|---|---|---|
| kimi-k2.5:cloud | 0.0 | 0% | 127866ms | 130419ms | $1.02 | $0.16 |
...
| Model | Avg Score | Pass Rate | Avg TTFT (ms) | Avg Total (ms) | Groq Equiv Cost/1k calls | OpenAI Equiv Cost/1k calls |
|---|---|---|---|---|---|---|
| kimi-k2.5:cloud | 0.0 | 0% | 58952ms | 61745ms | $1.13 | $0.18 |
