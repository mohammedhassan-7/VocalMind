## VocalMind Ollama Cloud Model Benchmark — 2026-06-16 15:30 UTC
...
| Model | Avg Score | Pass Rate | Avg TTFT (ms) | Avg Total (ms) | Groq Equiv Cost/1k calls | OpenAI Equiv Cost/1k calls |
|---|---|---|---|---|---|---|
| ministral-3:8b | 0.0 | 0% | 115033ms | 119462ms | $0.04 | $0.19 |
...
| Model | Avg Score | Pass Rate | Avg TTFT (ms) | Avg Total (ms) | Groq Equiv Cost/1k calls | OpenAI Equiv Cost/1k calls |
|---|---|---|---|---|---|---|
| ministral-3:8b | 0.0 | 0% | 59471ms | 59946ms | $0.01 | $0.02 |
