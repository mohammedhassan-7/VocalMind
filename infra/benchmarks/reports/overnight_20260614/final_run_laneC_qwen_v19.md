## VocalMind Ollama Cloud Model Benchmark — 2026-06-16 15:03 UTC
...
| Model | Avg Score | Pass Rate | Avg TTFT (ms) | Avg Total (ms) | Groq Equiv Cost/1k calls | OpenAI Equiv Cost/1k calls |
|---|---|---|---|---|---|---|
| qwen3.5:cloud | 0.0 | 0% | 118295ms | 119751ms | $0.10 | $0.04 |

### Stage: text_to_sql
| Model | Avg Score | Pass Rate | Avg TTFT (ms) | Avg Total (ms) | Groq Equiv Cost/1k calls | OpenAI Equiv Cost/1k calls |
|---|---|---|---|---|---|---|
| qwen3.5:cloud | 7.9 | 70% | 75306ms | 77045ms | $0.25 | $0.08 |
